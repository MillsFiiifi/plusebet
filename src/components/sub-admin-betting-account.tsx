 ...
 *
 * The wallet uses the same email and password as this dashboard login, so they
 * sign in at /login with the credentials they already have.
 */
        ...
        {!loaded ? (
          ...
          <>
            ...
            <p className="text-xs text-muted-foreground">
              This wallet is separate from your commission balance. Commission is paid out
              through your payout details; this is money you deposit and bet with.
            </p>
          </>
        ) : (
