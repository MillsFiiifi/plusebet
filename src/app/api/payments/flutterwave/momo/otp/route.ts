...
/**
 * Second step of the custom Flutterwave Ghana MoMo checkout: the customer
 * enters the SMS OTP on our own page and we validate the charge with
 * Flutterwave (using the flw_ref stashed on the pending row at /momo/start).
 * On success the collection proceeds and the UI polls /momo/status.
 */
export async function POST(request: Request) {
  ...
  // Code accepted — the collection is in flight; the UI polls /momo/status.
